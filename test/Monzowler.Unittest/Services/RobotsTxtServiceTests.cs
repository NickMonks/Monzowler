...
public class RobotsTxtServiceTests
    {
        ...
        //Small utility method to load and open files for testing robots.txt files
        ...
        {
            //Arrange 
            var content = LoadTestFile("valid_robots.txt");
            _mockApiClient
        ...
        {
            //Arrange 
            var content = LoadTestFile("multiple_agents_robots.txt");
            _mockApiClient
                .Setup(c => c.GetStringAsync(It.IsAny<string>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(content);
        ...
        {
            //Arrange
            var content = LoadTestFile("malformed_no_useragent.txt");
        ...
        {
            //Arrange
            var content = LoadTestFile("malformed_invalid_directive.txt");
        ...
        {
            //Arrange
            var content = LoadTestFile("valid_same_agent_robots.txt");
